  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        if (mounted) {
          setProducts([
            { id: 'p_1', name: 'Chessboard', price: 99, description: 'A canvas for the quiet storm within.', image: '/cheeseboard-hoodie.png', remaining: 96, needsSize: false },
            { id: 'p_2', name: 'Hoodie', price: 99, description: 'Oversized, loose-fit cut that drapes like a second skin.', image: '/hoodie-hero.png', remaining: 93, needsSize: true },
          ]);
        }
      } finally {
